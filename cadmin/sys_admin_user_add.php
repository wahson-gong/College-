...
if($dopost=='add')
{
    ...
    //后台管理员
    $inquery = "INSERT INTO `#@__admin`(id,usertype,userid,pwd,uname,typeid,tname,email,admin_city)
                                                    VALUES('$mid','$usertype','$userid','$pwd','$uname','$typeid','$tname','$email', '$citys'); ";
...
{
	$cityOptions .= "<option value='{$row->city_name}' class='stype'>—{$row->city_name}</option>\r\n";
}
